...
exports.SetsIntegrationService = void 0;
// TODO: add caching logic here
class SetsIntegrationService {
    constructor(brickLinkClient) {
        this.brickLinkClient = brickLinkClient;
    }
    getSetByCode(code) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.brickLinkClient.getSetByCode(code);
        });
    }
    getSetPricesByCode(code) {
        return __awaiter(this, void 0, void 0, function* () {
